...
export const ACTION_HANDLERS = {
    ...
    [EDIT_TRIGGERD]: (state, action) => {
        return Object.assign({}, state, {
            editTriggered: action.editTriggered,
            comboSelectedStatisticColumn: action.comboSelectedStatisticColumn
        })
    },
